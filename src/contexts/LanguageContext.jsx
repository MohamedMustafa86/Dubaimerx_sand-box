...
const translations = {
  en: {
    ...
    messaging_newConversation: 'New Conversation',
    messaging_searchConversations: 'Search conversations...',
    messaging_searchUsers: 'Search users...',
    messaging_noConversations: 'No conversations yet',
    messaging_startFirstConversation: 'Start your first conversation',
    messaging_selectConversation: 'Select a conversation',
    messaging_selectConversationDesc: 'Choose a conversation to start messaging',
    messaging_typeMessage: 'Type a message...',
    messaging_justNow: 'Just now',
    messaging_minutesAgo: 'm ago',
    messaging_hoursAgo: 'h ago',
    messaging_unknownUser: 'Unknown User',
    messaging_noMessages: 'No messages yet',
    messaging_noUsersFound: 'No users found',
    messaging_cancel: 'Cancel',
    messaging_conversationCreated: 'Conversation Created',
    messaging_conversationCreatedDesc: 'You can now start messaging!',
    messaging_errorLoadingMessages: 'Error loading messages',
    messaging_errorSendingMessage: 'Error sending message',
    messaging_errorLoadingUsers: 'Error loading users',
    messaging_errorCreatingConversation: 'Error creating conversation',
    messaging_errorUploadingFile: 'Error uploading file',
    messaging_fileUploaded: 'File uploaded',
    messaging_fileUploadedSuccess: 'File uploaded successfully',
    messaging_fileTooLarge: 'File too large',
    messaging_maxFileSize: 'Maximum file size is 10MB',
    messaging_online: 'Online',
    messaging_offline: 'Offline',
  ...
  ar: {
    ...
    // Messaging System
    messaging_conversations: 'المحادثات',
    messaging_newConversation: 'محادثة جديدة',
    messaging_searchConversations: 'البحث في المحادثات...',
    messaging_searchUsers: 'البحث عن المستخدمين...',
    messaging_noConversations: 'لا توجد محادثات بعد',
    messaging_startFirstConversation: 'ابدأ محادثتك الأولى',
    messaging_selectConversation: 'اختر محادثة',
    messaging_selectConversationDesc: 'اختر محادثة لبدء المراسلة',
    messaging_typeMessage: 'اكتب رسالة...',
    messaging_justNow: 'الآن',
    messaging_minutesAgo: 'د مضت',
    messaging_hoursAgo: 'س مضت',
    messaging_unknownUser: 'مستخدم غير معروف',
    messaging_noMessages: 'لا توجد رسائل بعد',
    messaging_noUsersFound: 'لم يتم العثور على مستخدمين',
    messaging_cancel: 'إلغاء',
    messaging_conversationCreated: 'تم إنشاء المحادثة',
    messaging_conversationCreatedDesc: 'يمكنك الآن بدء المراسلة!',
    messaging_errorLoadingMessages: 'خطأ في تحميل الرسائل',
    messaging_errorSendingMessage: 'خطأ في إرسال الرسالة',
    messaging_errorLoadingUsers: 'خطأ في تحميل المستخدمين',
    messaging_errorCreatingConversation: 'خطأ في إنشاء المحادثة',
    messaging_errorUploadingFile: 'خطأ في رفع الملف',
    messaging_fileUploaded: 'تم رفع الملف',
    messaging_fileUploadedSuccess: 'تم رفع الملف بنجاح',
    messaging_fileTooLarge: 'الملف كبير جداً',
    messaging_maxFileSize: 'الحد الأقصى لحجم الملف 10 ميجابايت',
    messaging_online: 'متصل',
    messaging_offline: 'غير متصل',
  ...
  fr: {
    ...
    // Messaging System
    messaging_conversations: 'Conversations',
    messaging_newConversation: 'Nouvelle Conversation',
    messaging_searchConversations: 'Rechercher des conversations...',
    messaging_searchUsers: 'Rechercher des utilisateurs...',
    messaging_noConversations: 'Aucune conversation pour le moment',
    messaging_startFirstConversation: 'Commencez votre première conversation',
    messaging_selectConversation: 'Sélectionner une conversation',
    messaging_selectConversationDesc: 'Choisissez une conversation pour commencer à échanger',
    messaging_typeMessage: 'Tapez un message...',
    messaging_justNow: 'À l\'instant',
    messaging_minutesAgo: 'm passées',
    messaging_hoursAgo: 'h passées',
    messaging_unknownUser: 'Utilisateur Inconnu',
    messaging_noMessages: 'Aucun message pour le moment',
    messaging_noUsersFound: 'Aucun utilisateur trouvé',
    messaging_cancel: 'Annuler',
    messaging_conversationCreated: 'Conversation Créée',
    messaging_conversationCreatedDesc: 'Vous pouvez maintenant commencer à échanger!',
    messaging_errorLoadingMessages: 'Erreur lors du chargement des messages',
    messaging_errorSendingMessage: 'Erreur lors de l\'envoi du message',
    messaging_errorLoadingUsers: 'Erreur lors du chargement des utilisateurs',
    messaging_errorCreatingConversation: 'Erreur lors de la création de la conversation',
    messaging_errorUploadingFile: 'Erreur lors du téléchargement du fichier',
    messaging_fileUploaded: 'Fichier téléchargé',
    messaging_fileUploadedSuccess: 'Fichier téléchargé avec succès',
    messaging_fileTooLarge: 'Fichier trop volumineux',
    messaging_maxFileSize: 'Taille maximale de fichier: 10MB',
    messaging_online: 'En ligne',
